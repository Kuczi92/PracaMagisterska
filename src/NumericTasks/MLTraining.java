 ...
 * @author Quchi
 */
public class MLTraining implements Runnable {
       ...
       public MLTraining (String pathPos, String pathNeg, String XML, String FileTest,Label percent,Label Title,ProgressBar Progress,
 ...
 protected static void test() throws IOException {
    ...
    Mat in = getMat(new File( FILE_TEST ).getAbsolutePath(),false);
...
protected static Mat getMat( String path ,boolean positive) throws IOException {
    ...
    public void run() {
            try 
            {
                ...
                Logger.getLogger(MLTraining.class.getName()).log(Level.SEVERE, null, ex);
            }
